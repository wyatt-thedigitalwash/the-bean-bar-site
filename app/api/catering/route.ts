...
export async function POST(request: Request) {
  try {
    ...
    const { name, phone, email, eventType, eventDate, eventSize, message } =
      body;
    ...
    await resend.emails.send({
      ...
      subject: `New Catering Inquiry – ${eventType} on ${eventDate}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #338A82;">New Catering Inquiry</h2>
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr style="border-bottom: 1px solid #eee;">
              <td style="padding: 10px 0; font-weight: bold;">Event Size</td>
              <td style="padding: 10px 0;">${eventSize}</td>
            </tr>
            <tr>
